...
<body>
    ...
    <div class="m-16 flex">
        <img src="img/USF-50.png" class="w-64" alt="">
        <div class="absolute left-[35%] right-16 hidden py-5 text-center text-black md:block">
            <h5 class="text-blue-900 font-bold absolute top-0 hidden text-center md:block text-3xl">USF-50 – Banknote Sorter</h5>
            <p class="text-lg font-normal mt-10 text-justify">Banknote handling machines must deliver both high efficiency combined with speed and accuracy. Glory’s USF-50 offers high-performance sensors for fitness sorting and superb counterfeit detection, while processing at a remarkably high speed of up to 720 notes per minute. With the demand for more efficient cash management within the bank branch ever-increasing, the USF-50 has been specifically designed to meet this requirement. A 2-pocket desktop sorter, which can meet all the demands of a modern banking operation, the USF-50 is suitable for any desktop application and allows extensive fitness sorting operations, even in small branches.</p>
    ...
    <div id="spek" class="ml-16 mr-16 relative flex-nowrap pt-4 space-x mt-32 m-15 pb-16">
        <h1 class="top-0 absolute text-blue-900 self-center text-2xl font-bold flex text-center">Spesification</h1>
        <p class="pb-20 left-0 mt-8 absolute text-justify text-black text-lg font-normal">Banknote handling machines must deliver both high efficiency combined with speed and accuracy. Glory’s USF-50 offers high-performance sensors for fitness sorting and superb counterfeit detection, while processing at a remarkably high speed of up to 720 notes per minute. With the demand for more efficient cash management within the bank branch ever-increasing, the USF-50 has been specifically designed to meet this requirement. A 2-pocket desktop sorter, which can meet all the demands of a modern banking operation, the USF-50 is suitable for any desktop application and allows extensive fitness sorting operations, even in small branches.</p>
