...
<body>
    ...
    <div id="spek" class="ml-16 mr-16 relative flex-nowrap pt-4 space-x mt-12 m-15">
    ...
    <div id="spek" class="ml-16 mr-16 relative flex-nowrap pt-4 space-x mt-12 m-15">
      ...
      <p class="pb-0 left-0 mt-3 absolute text-justify text-black text-lg font-normal">banknotes are sorted by quality/fitness, detecting folded corners, holes, soil, tears and tape as unfit notes.</p>
    </div>
