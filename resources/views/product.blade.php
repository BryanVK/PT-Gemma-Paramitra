...
<body>
    ...
    <header class="bg-white fixed top-0 z-50 w-full shadow-md" >
      ...
      <div id="product" class=" ml-16 mr-16 relative space-x mt-28  pb-12">
        <h1 class="top-0 text-blue-800 self-center text-3xl font-bold text-center">PRODUCTS</h1>
      </div>
      
      <div class="product">
        <div id="list-product" class="relative flex-nowrap self-center justify-center flex space-x">
            <a href="UW-500">
              <div href="UW-500" type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="UW-500" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
            <a href="USF-100">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="USF-100" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
            </div>
            </a>
            ...
            <a href="USF-50">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <h1 class="text-sm text-center font-semibold">Banknote Sorter</h1>
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="USF-50" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
            </div>
            </a>
            ...
            <a href="USF-300">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <h1 class="text-sm text-center font-semibold">Banknote Sorter</h1>
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="USF-300" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
            </div>
            </a>
        ...
        <div id="list-product" class="relative flex-nowrap self-center justify-center flex space-x ">
          <a href="GFB-800">
            <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
              ...
              <div class="flex items-center justify-center m-3 mt-5">
                  <a href="GFB-800" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:bg-white hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
              </div>
            </div>
          </a>
            ...
            <a href="GNH-700">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="GNH-700" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
            ...
            <a href="GFS-100">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <h1 class="text-sm text-center font-semibold">Series Banknote Counter</h1>
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="GFS-100" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
            </div>
            </a>
            ...
            <a href="WR-500">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="WR-500" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
          </div>
        ...
        <div id="list-product" class="relative flex-nowrap self-center justify-center flex space-x ">
            <a href="DE-100">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="DE-100" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:bg-white hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
            ...
            <a href="RBG-100">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="RBG-100" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
            ...
            <a href="CCR-10">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="CCR-10" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
            ...
            <a href="CP-11">
              <div type="button" class="duration-500 hover:list-image- text-xl m-5 px-4 py-1 w-60 h-72 bg-slate-100 shadow-md rounded-xl text-black hover:text-white hover:bg-blue-900 " >
                ...
                <h1 class="text-sm text-center font-semibold">Coin Counter</h1>
                <div class="flex items-center justify-center m-3 mt-5">
                    <a href="CP-11" type="submit" class="w-52 text-center items-center text-sm font-semibold text-white bg-slate-400 py-1 duration-500 hover:shadow-lg rounded-2xl mb-4">DETAIL</a>
                </div>
              </div>
            </a>
          </div>
