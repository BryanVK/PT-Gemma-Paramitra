      ...
      <div  class="relative w-full bg-black md:h-72 mt-16">
        <div class="relative h-46 overflow-hidden md:h-72">
            <div class=" duration-700 ease-in-out ">
                <img src="img/service.jpg" class="opacity-50 absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                ...
                <div class="relative flex items-center justify-center">
                  <div class="px-3 py-2 w-60 text-black hover:text-white rounded-xl mx-9 mt-20 bg-white hover:bg-blue-300 hover:duration-300">
                    <a href="services-maintenance">
                      <p class="font-semibold text-xl text-black ">Maintenance</p>
                    </a>
                  </div>
                  <div class="px-3 py-2 w-60 text-black  rounded-xl mx-9 mt-20 bg-blue-300 hover:bg-blue-200 hover:duration-300">
      ...
      <div class="relative h-56 overflow-hidden md:h-96">
          ...
          <div class=" duration-700 ease-in-out" data-carousel-item="active">
            <div id="maintenance" class="ml-16 mr-16 relative flex-nowrap pt-4 space-x mt-12 m-15 pb-16">
              <h1 class=" top-0 absolute text-blue-800 self-center text-3xl font-bold flex text-center">Service</h1>
